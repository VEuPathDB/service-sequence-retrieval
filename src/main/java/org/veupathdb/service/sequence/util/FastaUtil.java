...
public class FastaUtil {
  ...
  private static String deflineForFeature(Feature feature, DeflineFormat deflineFormat){
...
*/
  public static void appendSequenceToStream(OutputStream outputStream, Feature feature, DeflineFormat deflineFormat, byte[] bases, int basesPerLine) throws IOException {

    var defline = deflineForFeature(feature, deflineFormat);
